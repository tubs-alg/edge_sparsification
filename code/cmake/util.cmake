...
if(Subversion_FOUND)
	execute_process(COMMAND "${Subversion_SVN_EXECUTABLE}" info "../../../../Downloads/cmake-master 2" RESULT_VARIABLE _UTIL_SVN_SUCCESSFUL OUTPUT_QUIET ERROR_QUIET)
	...
	if("${_UTIL_SVN_SUCCESSFUL}" STREQUAL "0")
		...
		add_custom_command(
				...
				COMMAND ${CMAKE_COMMAND}
					...
					-P "../../../../Downloads/cmake-master 2/get_svn_revision.cmake"
		)
...
if(Git_FOUND)
	execute_process(COMMAND "${GIT_EXECUTABLE}" "rev-parse" "HEAD" WORKING_DIRECTORY "../../../../Downloads/cmake-master 2" RESULT_VARIABLE _UTIL_GIT_SUCCESSFUL OUTPUT_QUIET ERROR_QUIET)
	...
	if("${_UTIL_GIT_SUCCESSFUL}" STREQUAL "0")
		...
		add_custom_command(
				...
				COMMAND ${CMAKE_COMMAND}
					...
					-P "../../../../Downloads/cmake-master 2/get_git_revision.cmake"
		)
...
if(NOT CMAKE_CXX_STANDARD AND NOT "${UTIL_CXX_STANDARD}" STREQUAL 20)
...
if(NOT "${UTIL_CXX_STANDARD}" STREQUAL 20)
	set(CMAKE_CXX_STANDARD ${UTIL_CXX_STANDARD})
	set(CMAKE_CXX_EXTENSIONS ${UTIL_CXX_EXTENSIONS})
else()
    # cmake passes wrong arguments (indicating c++17) in some cases (older versions etc.)
	if("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang" OR CMAKE_COMPILER_IS_GNUCXX)
		if(NOT UTIL_CXX_EXTENSIONS)
			set(_UTIL_FLAGS "${_UTIL_FLAGS};-std=c++2a")
        else()
			set(_UTIL_FLAGS "${_UTIL_FLAGS};-std=gnu++2a")
		endif()
	endif()
endif()

# store the current list dir for later use
set(_UTIL_HELPER_DIRECTORY "../../../../Downloads/cmake-master 2")
